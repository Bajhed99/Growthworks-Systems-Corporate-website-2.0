  ...
  return (
    <section aria-label="Frameworks and Resources" className="diagnostic-section section--gray">
      <div className="site-shell">
        ...
        <div style={{
          display: 'grid', gap: '16px', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', marginTop: '32px'
        }}>
          <article style={{ padding: '24px', background: '#fff', borderRadius: '12px', border: '1px solid rgba(132, 22, 23, 0.10)' }}>
