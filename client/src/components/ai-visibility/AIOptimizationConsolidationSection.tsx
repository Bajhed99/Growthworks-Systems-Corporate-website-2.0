      ...
      <div className="site-shell">
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gap: '20px', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))' }}>
            ...
            <div>
              <h3 style={{ fontFamily: 'DM Serif Display, Georgia, serif', fontSize: '22px', fontWeight: 400, color: '#fff', marginBottom: '10px' }}>AEO — Answer Inclusion</h3>
              <p style={{ fontFamily: 'DM Sans, system-ui, sans-serif', fontSize: '15px', color: '#cbd5e1', lineHeight: 1.60 }}>
                Content must be clear, authoritative, and structured so that AI systems can extract and cite it confidently.
              </p>
            </div>
            <div>
              <h3 style={{ fontFamily: 'DM Serif Display, Georgia, serif', fontSize: '22px', fontWeight: 400, color: '#fff', marginBottom: '10px' }}>GEO — Generative Presence</h3>
              <p style={{ fontFamily: 'DM Sans, system-ui, sans-serif', fontSize: '15px', color: '#cbd5e1', lineHeight: 1.60 }}>
