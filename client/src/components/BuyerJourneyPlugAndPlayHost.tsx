...
import PackageApp from "./buyer-journey-package/App";
import packageStyles from "./buyer-journey-package/index.css?inline";
...
export function BuyerJourneyPlugAndPlayHost() {
